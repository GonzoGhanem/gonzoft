class Api::V1::SessionsController < Devise::SessionsController
  ...
  def create
    ...
    # render :status => 200, :json => { :success => true, :info => "Logged in", :user => current_user, :user_roles => current_user.roles }
    render json: current_user, :serializer => UserCreateSerializer
  end
